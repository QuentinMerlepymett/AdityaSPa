...
export function getRoutes() {
  const routes = [
  {
    ...
    "routes": [
      ...
      {
        "path": "/mobileTip",
        "component": dynamic({ loader: () => import(/* webpackChunkName: 'p__mobileTip' */'/Users/apple/Desktop/github/zhiku.tec/h5-visible-tool/src/pages/mobileTip'), loading: LoadingComponent}),
        "exact": true
      },
      {
        "path": "/preview",
